...
def summarise_results( prog, out_dir, log, pop_map, summary_html ):
    """
...
def __main__():
    ...
    summarise_results( options.stacks_prog, options.res_dir, options.logfile, options.pop_map, options.summary )
